...
export default function ContactHeader() {
  ...
  return (
    ...
    >
      <nav
        className={`uc-navbar-container rounded-0 uc-navbar-float ft-tertiary z-1 ${
          scrolledPast ? "uc-navbar-sticky lg:rounded-pill lg:mt-3" : "bg-green"
        } `}
        ...
        <div className="uc-navbar-main" style={{ "--uc-nav-height": "80px" }}>
            ...
            >
              ...
              <div className="uc-navbar-right" style={{ display: 'flex', alignItems: 'center' }}>
                <Link
                  href={`/meet`}
                  className="btn btn-sm px-3 d-none lg:d-inline-flex hover-bg-contact rounded-2 border border-white text-white bg-contact-default"
                >
