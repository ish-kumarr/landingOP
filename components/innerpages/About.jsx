          ...
          >
            <div className="vstack items-center gap-4 mb-4 sm:mb-6 lg:mb-8 max-w-850px mx-auto text-center">
              <h1 className="h2 sm:h1 lg:display-6 xl:display-5 m-0">
                About Outreach Panda.
              </h1>
              <p className="fs-6 md:fs-5 text-dark dark:text-white text-opacity-70">
                Outreach is evolving, and we’re leading the charge. At Outreach Panda, we believe outreach should be smarter, faster, and more personal. That’s why we built a platform that combines AI-driven lead discovery, human-like automation, and data-backed insights – so businesses can focus less on chasing and more on closing.
              </p>
            </div>
