        ...
        <div className="container max-w-lg">
          <div className="section-inner panel">
            <div className="panel vstack justify-center items-center gap-4 sm:gap-6 xl:gap-8 max-w-850px mx-auto">
              ...
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70 text-center">
                No positions open yet. Check back later.
              </p>
              <div className="panel">
                {/*
                <div
                  ...
                  {jobListings.map((job, index) => (
                    <div key={index}>
                      <div className="panel vstack justify-end items-end gap-1 p-3 rounded lg:rounded-2 bg-white dark:bg-gray-800">
                        ...
                        <button
                          disabled
                          className="uc-link fs-7 fw-bold d-inline-flex items-center gap-narrow border-bottom pb-narrow text-gray-500 bg-gray-200 cursor-not-allowed"
                        >
                          <span>Positions opening soon</span>
