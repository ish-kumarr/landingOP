...
export default function Cta() {
  return (
    <div id="cta-section" className="cta section panel overflow-hidden">
        ...
        >
          <div className="position-absolute top-50 start-0 translate-middle-y ms-n6">
            <Image
              ...
              alt="talking"
              src="/assets/images/home/letter.svg"
              width="195"
              height="254"
            />
            <Image
          ...
          <div className="position-absolute top-50 end-0 translate-middle-y me-n6">
            <Image
              className="w-200px xl:w-250px d-block dark:d-none"
              alt="chatting"
              src="/assets/images/home/thumbs.svg"
              width="255"
              height="283"
            />
            <Image
          ...
          <div className="section-inner panel">
            ...
            >
              ...
              <p className="fs-6 sm:fs-5 text-dark dark:text-white text-opacity-70 mt-1 lg:mt-2">
                Book a free consultation to see how Outreach Panda can help you.
              </p>
